...
// 	err := Rip(context.Background(), dir, results, &Filter{SHA: "591377c17227ffa7134812188bbbda685e366b21", Limit: 1}, false)
// 	assert.NoError(err)
// 	close(results)
// 	select {
...
// 	dir := filepath.Join(cwd, "..")
// 	var count int
// 	err := Rip(context.Background(), dir, results, &Filter{SHA: "db285eb2a083c8d764a55841e6b83a0eb9130516", Limit: 7}, false)
// 	assert.NoError(err)
// 	close(results)
